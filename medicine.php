    ...
    <table width="418" border="3" style="color:black">
      <tbody>
        <tr>
          ...
          <td width="66%"><input type="text" name="medicinename" id="medicinename" placeholder="Enter Medicine Name" value="<?php echo $rsedit[medicinename]; ?>" /></td>
        </tr>
        <tr>
          <td width="34%">Medicine cost</td>
          <td width="66%"><input type="text" name="medicinecost" id="medicinecost" placeholder="Enter Medicine Cost" value="<?php echo $rsedit[medicinecost]; ?>" /></td>
        </tr>
        <tr>
          <td>Description</td>
